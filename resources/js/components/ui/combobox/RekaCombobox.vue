...
<template>
  <ComboboxRoot :model-value="internalValue" :filter-function="serverSearch ? (() => true) : undefined" :open="open"
    @update:model-value="onUpdateModelValue" @update:open="onOpenChange">
    <ComboboxAnchor
      ...
      <ComboboxInput v-model="searchTerm" class="flex-1 bg-transparent outline-none placeholder:text-muted-foreground"
        :placeholder="placeholder" :display-value="(item: any) => item?.label ?? selectedLabel"
