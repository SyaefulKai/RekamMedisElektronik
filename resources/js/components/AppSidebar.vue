...
import { index as MedicationIndex } from '@/actions/App/Http/Controllers/Resources/MedicationController.js';
...
const authorization: NavItem[] = [{ title: 'Peran', href: RoleIndex().url, permission: 'view.role' }];

const userManagement: NavItem[] = [{ title: 'Data Pengguna', href: UserIndex().url, permission: 'view.user' }];

const practitionerManagement: NavItem[] = [{ title: 'Data Praktisi', href: PractitionerIndex().url, permission: 'view.practitioner' }];

const procedureManagement: NavItem[] = [{ title: 'Data Tindakan', href: ProcedureIndex().url, permission: 'view.procedure' }];

const medicationManagement: NavItem[] = [
    { title: 'Master Obat', href: MedicationIndex().url, permission: 'view.dashboard' },
    {
        title: 'Tambah Stok Obat',
        href: MedicationStockCreate().url,
...
<template>
    <Sidebar collapsible="icon" variant="inset">
        ...
        <SidebarContent>
            ...
            <NavGroup label="Obat" :icon="Pill" permission="view.dashboard" :items="medicationManagement" />
        </SidebarContent>
